...
(function() {
    ...
    let option = {
        ...
        xAxis: [{
            type: 'category',
            // x轴中更换data数据
            data: ["旅游行业", "教育培训", "游戏行业", "医疗行业", "电商行业", "金融行业"],
            axisTick: {
                alignWithLabel: true
            },
            //设置刻度标签相关样式
...
(function() {
    let yearData = [{
        ...
        },
        {
            year: '2020', // 年份
            data: [ // 两个数组是因为有两条线
                [78, 240, 97, 134, 90, 128, 66, 230, 120, 230, 210, 120],
                [40, 264, 191, 324, 90, 130, 210, 213, 180, 300, 280, 79]
            ]
        }
    ];
    let barColor = ['#00f2f1', '#ed3f35'];
    //1.创建实例对象
    ...
    let option = {
        ...
        series: [{
            ...
            data: [
                ...
                { value: 17, name: "30-39岁" },
                { value: 14, name: "40-49岁" },
                { value: 6, name: "50岁以上" }
            ],
        }]
    };
...
(function() {
    ...
    let color = ['#a6c84c', '#ffa022', '#46bee9', '#6a5ee6']; //航线的颜色
    let series = [];
    [
        ['西安', XAData],
        ['长沙', CSData],
